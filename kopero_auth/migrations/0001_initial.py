    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('PHOTOGRAPHER', 'photographer'), ('REGULAR', 'regular'), ('operations', 'Operations Admin')], default='Regular', help_text='Designates the role of the user in the system - For Authorization', max_length=20, verbose_name='user role')),
        ...
        migrations.AddIndex(
            model_name='profile',
            index=models.Index(fields=['-created_at'], name='kopero_auth_created_8d94e9_idx'),
        ),
    ]
